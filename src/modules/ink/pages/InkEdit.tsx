...
export default function InkEdit() {
  ...
  // Pakujemy pobieranie w useCallback, aby uniknąć problemów z zależnościami useEffect
  ...
  if (loading) return <div className="p-6 text-slate-400 italic">Wczytywanie danych pojemnika...</div>;
  if (!ink) return <div className="p-6 text-red-400">Nie znaleziono farby o podanym ID.</div>;
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-xl">
        <InkForm initialData={ink} onSubmit={handleSubmit} />
      </div>
    </div>
  );
}